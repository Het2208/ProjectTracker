  ...
  return (
    <aside className={`app-sidebar ${collapsed ? 'collapsed' : ''}`}>
      ...
      <ul className="sidebar-menu">
        ...
        <li>
          <Link to="/faculty/projects" className={`sidebar-link ${isActive('/faculty/projects') ? 'active' : ''}`}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <li>
          <Link to="/faculty/evaluations" className={`sidebar-link ${isActive('/faculty/evaluations') ? 'active' : ''}`}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <li>
          <Link to="/faculty/batches" className={`sidebar-link ${isActive('/faculty/batches') ? 'active' : ''}`}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <li>
          <Link to="/faculty/feedback" className={`sidebar-link ${isActive('/faculty/feedback') ? 'active' : ''}`}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
