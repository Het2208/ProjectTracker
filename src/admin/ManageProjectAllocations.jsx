...
const ManageProjectAllocations = () => {
  ...
  const facultyList = [
    { userID: 2, fullName: 'Prof. Madhuresh Fichadiya' },
    { userID: 5, fullName: 'Dr. Amit Vora' }
  ];
  ...
  const handleSubmit = (e) => {
    ...
    const faculty = facultyList.find(f => f.userID.toString() === formData.facultyID);

    if (!project || !student || !faculty) return;
