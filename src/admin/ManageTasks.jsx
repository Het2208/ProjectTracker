              ...
              <div style={{ padding: '24px' }}>
                ...
                <div className="form-group">
                  ...
                  <textarea 
                    id="taskDescription"
                    className="form-control" 
                    placeholder="Provide details about task deliverable criteria..."
                    rows="3"
                ...
                <div className="form-row">
                  <div className="form-group">
                    <label className="form-label" htmlFor="projectId">Related Project</label>
                    <select 
                      id="projectId"
                      className="form-control"
                  ...
                  <div className="form-group">
                    <label className="form-label" htmlFor="priorityId">Priority Level</label>
                    <select 
                      id="priorityId"
                      className="form-control"
                ...
                <div className="form-row">
                  <div className="form-group">
                    <label className="form-label" htmlFor="assignedScore">Weightage (Score Points)</label>
                    <input 
                      type="number" 
                      id="assignedScore"
                      className="form-control" 
